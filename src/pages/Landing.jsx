...
// Rotating pull quote shown in the "FROM THE FIELD" card. A fresh
// quote is picked per mount; the last index is stored in localStorage
// so consecutive page loads never repeat the same one.
const FIELD_QUOTES = [
